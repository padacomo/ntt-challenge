...
export interface IGetAllFavoriteMoviesUseCase {
    execute(param: IGetAllMoviesRequest): Promise<PaginationResponseType<FavoriteMovie>>;
}
export declare const IGetAllFavoriteMoviesCaseName = "IGetAllFavoriteMoviesCase";
